...
public class PieProgReviewTAReportResultAction implements Action 
{
        ...
        */
        ...
        while ( orgUnitIterator.hasNext() )
        {
            ...
            for( String selReview : selectedList )
            {
                ...
                //Review Type (ie PIE / EPI etc) (0th Index)
                reviewList.add( selReview.split( ":" )[0] );

                //When was the last EPI review conducted? (1st Index)
                ...
                //When is the next EPI review planned? (2nd Index)
    ...
    private Date getStartDateByString( String dateStr )
    {
        ...
        else if( startDateParts.length == 2 && cal.get( Calendar.MONTH ) == Integer.parseInt( startDateParts[1] ) )
        {
        	startDate = startDateParts[0] + curMonth + curDay;
        }
        else
