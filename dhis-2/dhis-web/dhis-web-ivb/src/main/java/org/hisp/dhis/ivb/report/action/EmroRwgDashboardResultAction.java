 ...
 * @author BHARATH
 */
public class EmroRwgDashboardResultAction implements Action
{
    // -------------------------------------------------------------------------
    // Dependencies
    // -------------------------------------------------------------------------
    ...
    public String execute()
    {
        ...
        Lookup lookup = lookupService.getLookupByName( Lookup.EMRO_RWG_DASHBOARD_PARAMS );
        String report_params = lookup.getValue();
        
        String ouGroupUId = report_params.split( "-" )[0];

        if ( ouGroupUId != null )
        {
        	OrganisationUnitGroup ouGroup = orgUnitGroupService.getOrganisationUnitGroup( ouGroupUId );
            orgUnitList = new ArrayList<OrganisationUnit>( ouGroup.getMembers() );
        ...
        String dataElementIdsByComma = report_params.split( "-" )[1];
